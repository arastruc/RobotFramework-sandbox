...
${file_2} =  second file.js
${file_3} =  third file.yml
...
Move File 3 from Directory 2 to Directory 1
    ...
    ${files_in_directory_1_count}=    Count Files In Directory    Outputs/first directory
    Should Be Equal As Numbers    ${files_in_directory_1_count}    2
...
Delete Working Directory
    Remove Directory    ${output_directory}    ${True}